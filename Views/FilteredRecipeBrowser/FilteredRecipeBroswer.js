  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, backgroundColor: "white" }}>
        <ScrollView
          contentContainerStyle={styles.mainContainer(darkTheme)}
          ref={scrollRef}
        >
                ...
                if (i >= pagestart && i <= pageend) {
                  return (
                    <TouchableOpacity
                      ...
                      style={styles.singlefood(darkTheme)}
                      key={i}
                    >
                      <Image
                      ...
                      <View style={{ marginRight: 20 }}>
                        ...
                        <Text style={styles.nametext(darkTheme)}>
                          {data.name.length > 40
          ...
          <View style={styles.pagingview}>
            <Button
              buttonColor={pagestart <= 0 ? "#e5e5e5" : "#fd5a43"}
            ...
            <Button
              buttonColor={pageend > item.length ? "#e5e5e5" : "#fd5a43"}
              icon="arrow-right-bold-circle"
              mode="contained"
              onPress={() => {
                pageForward();
              }}
              disabled={pageend > item.length ? true : false}
              style={{ marginLeft: 20 }}
