...
import { showContext, foodContext, themeContext } from "../Components/SetData.js"
    ...
    return (
      <ScrollView contentContainerStyle={styles.randomContainer}>
        ...
        <View style={styles.headerContainer}>
          <Text style={styles.headerText}>{randelement.name}</Text>
        ...
        <Text style={styles.descriptiontext(darkTheme)}>Description: {randelement.description}</Text>
        <Text style={styles.difficultytext(darkTheme)}>Dish Difficulty: {randelement.difficulty}</Text>
        <Text style={styles.typetext(darkTheme)}>Dish Type: {randelement.type}</Text>
        <Text style={styles.upperrecipetext(darkTheme)}>Recipe for this Meal:</Text>
        <Text style={styles.recipeText(darkTheme)}>{randelement.recipe}</Text>

        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.gobackButton(darkTheme)} onPress={() => { hideComponent() }}><Text style={styles.gobackbuttontext(darkTheme)}>Go back</Text></TouchableOpacity>
    ...
    <KeyboardAvoidingView style={styles.mainContainer(darkTheme)}>
      ...
      {!show &&
        ...
        <View style={styles.questioncontainer(darkTheme)}>
          ...
          <TouchableOpacity style={styles.button(darkTheme)} onPress={() => { showComponent() }}>
